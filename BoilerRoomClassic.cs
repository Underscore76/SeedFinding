...
namespace SeedFinding
{
    public class BoilerRoomClassic
    {
        ...
        public static bool ValidSeed(uint gameId, bool curate = false)
        {
            int fireQuartz = 0;
            int frozenTear = 0;
